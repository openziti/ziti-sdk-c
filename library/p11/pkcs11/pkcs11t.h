...
CK_BYTE_PTR;
typedef CK_CHAR CK_PTR
CK_CHAR_PTR;
typedef CK_UTF8CHAR CK_PTR
CK_UTF8CHAR_PTR;
typedef CK_ULONG CK_PTR
CK_ULONG_PTR;
typedef void CK_PTR
CK_VOID_PTR;

/* Pointer to a CK_VOID_PTR-- i.e., pointer to pointer to void */
typedef CK_VOID_PTR CK_PTR
CK_VOID_PTR_PTR;
...
typedef CK_SESSION_HANDLE CK_PTR
...
typedef CK_SESSION_INFO CK_PTR
CK_SESSION_INFO_PTR;
...
typedef CK_OBJECT_HANDLE CK_PTR
...
typedef CK_OBJECT_CLASS CK_PTR
CK_OBJECT_CLASS_PTR;
...
typedef CK_MECHANISM_TYPE CK_PTR
...
typedef CK_MECHANISM_INFO CK_PTR
...
typedef CK_FUNCTION_LIST_PTR CK_PTR
...
typedef CK_C_INITIALIZE_ARGS CK_PTR
...
typedef CK_RSA_PKCS_MGF_TYPE CK_PTR
...
typedef CK_RSA_PKCS_OAEP_SOURCE_TYPE CK_PTR
...
typedef CK_RSA_PKCS_PSS_PARAMS CK_PTR
...
typedef CK_ECDH1_DERIVE_PARAMS CK_PTR
...
typedef CK_ECDH2_DERIVE_PARAMS CK_PTR
...
typedef CK_ECMQV_DERIVE_PARAMS CK_PTR
...
typedef CK_X9_42_DH_KDF_TYPE CK_PTR
...
typedef CK_X9_42_DH2_DERIVE_PARAMS CK_PTR
...
typedef CK_X9_42_MQV_DERIVE_PARAMS CK_PTR
...
typedef CK_KEA_DERIVE_PARAMS CK_PTR
...
typedef CK_RC2_CBC_PARAMS CK_PTR
...
typedef CK_RC5_CBC_PARAMS CK_PTR
...
typedef CK_MAC_GENERAL_PARAMS CK_PTR
...
typedef CK_SSL3_KEY_MAT_OUT CK_PTR
...
typedef CK_SSL3_KEY_MAT_PARAMS CK_PTR
...
typedef CK_TLS_PRF_PARAMS CK_PTR
...
typedef CK_WTLS_RANDOM_DATA CK_PTR
...
typedef CK_WTLS_PRF_PARAMS CK_PTR
...
typedef CK_WTLS_KEY_MAT_OUT CK_PTR
...
typedef CK_WTLS_KEY_MAT_PARAMS CK_PTR
...
typedef CK_CMS_SIG_PARAMS CK_PTR
...
typedef CK_EXTRACT_PARAMS CK_PTR
...
typedef CK_PKCS5_PBKD2_PARAMS CK_PTR
...
typedef CK_PKCS5_PBKD2_PARAMS2 CK_PTR
...
typedef CK_OTP_SIGNATURE_INFO CK_PTR
...
typedef CK_AES_CTR_PARAMS CK_PTR
...
typedef CK_AES_CCM_PARAMS CK_PTR
...
typedef CK_CAMELLIA_CTR_PARAMS CK_PTR
...
typedef CK_DSA_PARAMETER_GEN_PARAM CK_PTR
...
typedef CK_ECDH_AES_KEY_WRAP_PARAMS CK_PTR
...
typedef CK_RSA_AES_KEY_WRAP_PARAMS CK_PTR
...
typedef CK_TLS12_KEY_MAT_PARAMS CK_PTR
...
typedef CK_TLS_KDF_PARAMS CK_PTR
...
typedef CK_TLS_MAC_PARAMS CK_PTR
...
typedef CK_GOSTR3410_DERIVE_PARAMS CK_PTR
...
typedef CK_GOSTR3410_KEY_WRAP_PARAMS CK_PTR
